...
@PostMapping("/logar/")
public String logar2(Model model, UsuarioUrbana admParam, String lembrar, HttpServletResponse response) throws IOException{
    UsuarioUrbana adm = this.repo.Login2(admParam.getEmail(), admParam.getSenha());
  if(adm != null){
...
@GetMapping("/sair/")
public String logar2(HttpServletResponse response) throws IOException{
